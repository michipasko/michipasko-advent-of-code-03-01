/*
Task 1
1. transform wirePath string in array  
2. each array element becomes an coordinate and is saved in a new array
- split each array elemente into direction and distance 
3. compare the both coordinate arrays and save all interceptions in an interception array
4. calculate the intersection point closest to the central port
...
const wirePathTest1 = "R8,U5,L5,D3"
const wirePathTest2 = "U7,R6,D4,L4"
const wirePathTest3 = "R75,D30,R83,U83,L12,D49,R71,U7,L72"
const wirePathTest4 = "U62,R66,U55,R34,D71,R55,D58,R83"
const wirePathTest5 = "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51"
const wirePathTest6 = "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
    ...
    for (let untransformedCoordinate of wirePathArray) {
        if (untransformedCoordinate[0] === "R") {
            ...
            for (let i = 1; i <= distance; i++) {
                ...
                coordinateToPush[0] ++
                wirePathArrayTransformed.push(coordinateToPush)
...
const wirePathArrayTransformed1 = transformArray(wirePathString1, transformToArray)

const wirePathArrayTransformed2 = transformArray(wirePathString2, transformToArray)

const wirePathArrayTransformed1_1 = []
const wirePathArrayTransformed1_2 = []

for (let e of wirePathArrayTransformed1) {
    wirePathArrayTransformed1_1.push(e.join())
}

for (let e of wirePathArrayTransformed2) {
    wirePathArrayTransformed1_2.push(e.join())
}

const newArr = []

for (let e of wirePathArrayTransformed1_1) {
    if (wirePathArrayTransformed1_2.includes(e)) {
        newArr.push(e)
    }
}
...
for (let e of newArr) {
    e = e.split(",")
    let sum = Math.abs(parseInt(e[0])) + Math.abs(parseInt(e[1]))
    sumArr.push(sum)
}

console.log("Solution Task 1:", Math.min(...sumArr))
